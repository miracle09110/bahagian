...
var createFolderList = async result => {
    await result.topics.forEach((element, index) => {
        ...
        if (element.authorized) {
            ...
            modalContentBody.innerHTML = "You will only be granted access to the requested topic once you upload a file. After contribution, access link will be sent to your email "
            ...
            wrapperFileUploadButton.innerHTML = '<input class="file-path validate" type="text" place-holder="Contribution File">'
